...
class RrtStar:
    def __init__(self, img, x_start, x_goal, step_len,
                 goal_sample_rate, search_radius, iter_max,stepsize = 15,plotting_flag = False,directCon_flag = False):       
...
def main():
    img = cv2.imread('/home/ahmad/Desktop/uBot_system_UDell/Magnetoacoustic-Microrobotic-Manipulation-System/imgs/cropped_image.jpg',0)   
    x_start = (18, 8)  # Starting node
    x_goal = (1000, 900)  # Goal node

    # Import an image: 

    rrt_star = RrtStar(img = img, x_start = x_start, x_goal=x_goal, step_len=50,
...
if __name__ == '__main__':
    main()
# TODO: 
# - Update the env class    -- DONE
# - Extract a static image to test with -- DONE
# - Collision Check, DONE  
# - Run with the system, DONE
# - Direct connection to the goal
# - Make the proper changes on the dimensions 
# - Update the cost to come, DONE
# - Plotting, DONE 